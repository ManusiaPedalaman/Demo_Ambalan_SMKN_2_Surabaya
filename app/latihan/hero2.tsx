...
export default function HeroLatihan() {
  // Fungsi untuk scroll ke section konten
  const handleScroll = () => {
  ...
  // Definisi Variants dengan Tipe Eksplisit
  ...
  return (
    <section className={`w-full min-h-screen bg-white pt-28 pb-20 ${dmSans.className}`}>
      <motion.div 
        ...
        <div className="flex flex-col items-center text-center mb-12 md:mb-24">
          ...
          <motion.div variants={itemVariants} className="w-full">
            <p className="text-gray-600 text-sm md:text-base mb-8 md:mb-10 font-normal tracking-wide px-4">
              cari metode pelatihan yang kamu ingin kan
            </p>
          </motion.div>

          {/* Button Container with Lines */}
          <motion.div 
      ...
      {/* Dummy Section untuk target Scroll */}
