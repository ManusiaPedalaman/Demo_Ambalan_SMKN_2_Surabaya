...
export default function Kt3() {
  ...
  return (
    <section
      ...
      className={`w-full bg-[#1E1C1B] py-25 md:py-28 overflow-hidden ${dmSans.className}`}
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-8 md:mb-20">
          <motion.h2
            ...
            className="text-2xl md:text-4xl lg:text-5xl font-bold text-white mb-4 md:mb-6 tracking-tight"
          >
          ...
          <motion.p
            ...
            whileInView="visible"
            viewport={{ once: true, amount: 0.5 }}
            className="text-gray-400 text-xs md:text-base max-w-3xl mx-auto leading-relaxed px-2"
          >
