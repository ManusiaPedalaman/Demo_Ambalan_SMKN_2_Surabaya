...
const Footer = () => {
  ...
  return (
    ...
    >
      ...
      <div className={`max-w-7xl mx-auto flex flex-col lg:flex-row gap-12 lg:gap-20 transition-all duration-1000 transform ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
        }`}>
        ...
        <div className="w-full lg:w-[55%] flex flex-col">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-4 gap-x-8">
            ...
            <div className="flex flex-col gap-4">
              ...
              <a href="https://github.com/ManusiaPedalaman" target="_blank" rel="noopener noreferrer" className="text-gray-500 font-medium hover:text-[#C7A682] hover:translate-x-1 transition-all duration-300 w-fit">
                Kontak
              </a>
            </div>
          </div>
      ...
      <div className={`max-w-7xl mx-auto mt-16 pt-8 border-t border-gray-100 transition-all duration-1000 delay-300 transform ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
        }`}>
